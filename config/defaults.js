...
define({
    ...
    "locationSearch": true, // Use organization geocoders?
    "searchExtent": false, // When searchExtent is true the locator will prioritize results within the current map extent
    "searchLayers": [{
        "id": "",
        "fields": []
    }],
